...
def parse_url(link):
	...
	attribute = soup.select_one('iframe#player').attrs # Lấy player attributes
	url = attribute.get('src')
	title = attribute.get('title')
	player_url = 'https://apix.gooqlevideo.com/player' + url.split('videoplayback')[1] # Lấy player url
